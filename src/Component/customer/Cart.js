...
class Cart extends Component{
  ...
  componentDidMount(){
    ...
    this.setState=("Please login to view cart details");
        ...
        <div class="row">
          <div class="col-md-8 cart">
            ...
            <div class="row border-top border-bottom">
                ...
                <div class="col-2"><img class="img-fluid" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIgZH2kjjCZl8AGMtPdtWLKMA3dRW5bWcBaQ&usqp=CAU"/></div>
                    <div class="col">
